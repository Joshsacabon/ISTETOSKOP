            ...
            <label htmlFor="Birthday"><h5>Full Name:</h5></label>
                ...
                <div className="row g-3 align-items-center">
                    ...
                    <div className="col-auto">
                        ...
                        <input className="form-control " name="Fname" type="text" id="Age"/>
                    </div>
                </div>
                <br/>
                <div className="row g-3 align-items-center">
                    ...
                    <div className="col">
                        ...
                        <input className="form-control " name="Fname" type="text" id="CellNumber"/>
                    </div>
                    <div className="col-auto">
                        <label htmlFor="Gender"><h5>Gender:</h5></label>
                        <select class="form-select" id="Gender" name="Fname">
                ...
                <div className="row g-3 align-items-center">
                    <div className="col-12">
                        <input className="form-control " name="Fname" type="text" id="SAddress"/>
                        <label class="text-secondary"  htmlFor="SAddress">Street Address</label>
                    </div>
                    <div className="col-4">
                        <input className="form-control " name="Fname" type="text" id="City"/>
                        <label class="text-secondary" htmlFor="City">City</label>
                    </div>
                    <div className="col-4">
                        <input className="form-control " name="Fname" type="text" id="Province"/>
                        <label class="text-secondary" htmlFor="Province">Province</label>
                    </div>
                    <div className="col-4">
                        <input className="form-control " name="Fname" type="text" id="zipcode"/>
                        <label class="text-secondary" htmlFor="zipcode">Zip Code</label>
                    </div>
                    <div className="col-12">
                        <input className="form-control " name="Fname" type="text" id="country"/>
